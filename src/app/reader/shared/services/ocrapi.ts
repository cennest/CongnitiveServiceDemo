...
export class OCRAPI {
    ...
    subscriptionKey = '60c88c22c13e4e038e92ffd7503ea57b';
    ...
    readTextFromImage() {
        ...
        const imageUrl = `https://image.slidesharecdn.com/opticalcharacterrecognitionforbanglahandwrittentext-120207073409-phpapp02/95/optical-character-recognition-for-bangla-handwritten-text-4-728.jpg?cb=1328600115`;
